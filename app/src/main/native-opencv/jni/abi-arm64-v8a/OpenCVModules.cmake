...
# Set OpenCV SDK path
set(OpenCV_SDK_PATH "C:/Users/Srijana/Downloads/opencv-4.11.0-android-sdk/OpenCV-android-sdk")

# Protect against multiple inclusion, which would fail when already imported targets are added once more.
set(_targetsDefined)
set(_targetsNotDefined)
set(_expectedTargets)
foreach(_expectedTarget libjpeg-turbo libtiff libwebp libopenjp2 libpng IlmImf tbb libprotobuf tegra_hal kleidicv_neon kleidicv_sve2 kleidicv kleidicv_thread kleidicv_hal ittnotify ade opencv_core opencv_flann opencv_imgproc opencv_ml opencv_photo ocv.3rdparty.flatbuffers opencv_dnn opencv_features2d opencv_imgcodecs ocv.3rdparty.android_mediandk opencv_videoio opencv_calib3d opencv_highgui opencv_objdetect opencv_stitching opencv_video opencv_gapi opencv_java)
...
if(NOT TARGET libcpufeatures)
    add_library(libcpufeatures STATIC IMPORTED)
    set_target_properties(libcpufeatures PROPERTIES
        IMPORTED_LOCATION "${CMAKE_CURRENT_LIST_DIR}/../../../libs/arm64-v8a/libcpufeatures.a")
endif()

# Create imported target libjpeg-turbo
add_library(libjpeg-turbo STATIC IMPORTED)
set_target_properties(libjpeg-turbo PROPERTIES
  IMPORTED_LOCATION "${OpenCV_SDK_PATH}/sdk/native/3rdparty/libs/${ANDROID_ABI}/liblibjpeg-turbo.a")
...
set_target_properties(libwebp PROPERTIES
  ...
  IMPORTED_LOCATION "${OpenCV_SDK_PATH}/sdk/native/3rdparty/libs/${ANDROID_ABI}/liblibwebp.a")
...
set_target_properties(opencv_core PROPERTIES
    INTERFACE_LINK_LIBRARIES "dl;m;log;tbb;z;cpufeatures"
    IMPORTED_LOCATION "${OpenCV_SDK_PATH}/sdk/native/staticlibs/${ANDROID_ABI}/libopencv_core.a")
...
set_target_properties(opencv_imgproc PROPERTIES
    INTERFACE_LINK_LIBRARIES "opencv_core;dl;m;log")
...
set_target_properties(opencv_features2d PROPERTIES
    INTERFACE_LINK_LIBRARIES "opencv_core;opencv_imgproc;dl;m;log")
...
# Create imported target opencv_java4
add_library(opencv_java4 SHARED IMPORTED)
set_target_properties(opencv_java4 PROPERTIES
    IMPORTED_LOCATION "${OpenCV_SDK_PATH}/sdk/native/libs/${ANDROID_ABI}/libopencv_java4.so"
    INTERFACE_INCLUDE_DIRECTORIES "${OpenCV_SDK_PATH}/sdk/native/jni/include")
...
# Set OpenCV paths
set(OpenCV_INCLUDE_DIRS "${CMAKE_CURRENT_LIST_DIR}/../../../jni/include")

# Set OpenCV libraries
set(OpenCV_LIBS opencv_core opencv_imgproc opencv_features2d opencv_highgui opencv_java4 cpufeatures)
